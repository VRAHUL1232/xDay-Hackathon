  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="w-full max-w-md p-6 bg-white rounded-lg shadow-md">
        <h1 className="text-3xl font-bold text-center text-sky-600">HADAP</h1>
        ...
        <form onSubmit={isLogin ? handleLogin : handleSignup} className="mt-6">
          <div className="mb-4">
            ...
            <input
              ...
              required
              className="w-full mt-1 p-2 border rounded-md focus:border-sky-600 focus:ring focus:ring-sky-200"
            />
          </div>
          ...
          <button
            type="submit"
            className="w-full mt-4 py-2 bg-sky-600 text-white rounded-md hover:bg-sky-700 transition"
          >
...
const LoginPage = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      const signInResponseTrigger = await fetch('http://127.0.0.1:5002/login', {
        method: 'POST',
        body: formData,
        headers: {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      const signUpResponseTrigger = await fetch('http://127.0.0.1:5002/register', {
        method: 'POST',
        body: formData,
        headers: {
          // Remove Content-Type header when using FormData
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white">
      <div className="w-full max-w-md p-6 bg-white rounded-lg shadow-md">
        <h1 className="text-3xl font-bold text-center text-sky-500">Malware Slayer</h1>
        <p className="text-center text-gray-600 mt-2">
          {isLogin ? 'Login to access your dashboard' : 'Sign up to get started'}
        </p>
