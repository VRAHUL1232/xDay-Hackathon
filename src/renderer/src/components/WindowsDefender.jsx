...
const WindowsDefender = ({ onBack }) => {
  ...
  const createSnapshot = async () => {
    try {
      ...
      formData.append('vm_name', 'Windows Defender');
  ...
  return (
    <div>
      ...
      <div
        ...
        <h1 className="text-purple-800 text-3xl font-semibold">Windows Defender Backup</h1>
        <p className="text-gray-500 text-medium font-semibold mt-2">
          Manage snapshots (backups) for the Windows Defender VM below.
        </p>
        ...
        <p className="text-xl font-semibold mt-4">
          Add a new snapshot for the Windows Defender VM.
        </p>
        <button
